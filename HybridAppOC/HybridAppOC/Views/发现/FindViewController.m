...
- (void) customNavItem {
    ...
    NSArray *items = @[@"最新", @"附近"];
    LMYHybridViewController *follow = [LMYHybridViewController load:@"http://172.16.16.155:8085/#/find" sess:nil args:nil];
    LMYHybridViewController *hot
    = [LMYHybridViewController load:@"http://172.16.16.155:8085/#/nearby" sess:nil args:nil];
    // 3 添加标题数组和控住器数组
