...
- (void) customNavItem {
    ...
    NSArray *items = @[@"关注", @"最热"];
    LMYHybridViewController *follow = [LMYHybridViewController load:@"http://172.16.16.234:8080/#/" sess:nil args:nil];
    LMYHybridViewController *hot
    = [LMYHybridViewController load:@"http://172.16.16.234:8080/#/hot" sess:nil args:nil];
    // 3 添加标题数组和控住器数组
